...
echo "charityName.error.required = Enter charityName" >> ../conf/messages.en
echo "charityName.error.length = CharityName must be 100 characters or less" >> ../conf/messages.en
...
awk '/class CheckYourAnswersHelper/ {\
     print;\
     print "";\
     print "  def charityName: Option[Row] = userAnswers.get(CharityNamePage) map {";\
     print "    answer =>";\
     print "      Row(";\
     print "        key     = Key(msg\"charityName.checkYourAnswersLabel\", classes = Seq(\"govuk-!-width-one-half\")),";\
     print "        value   = Value(lit\"$answer\"),";\
     print "        actions = List(";\
     print "          Action(";\
     print "            content            = msg\"site.edit\",";\
     print "            href               = routes.CharityNameController.onPageLoad(CheckMode).url,";\
     print "            visuallyHiddenText = Some(msg\"site.edit.hidden\".withArgs(msg\"charityName.checkYourAnswersLabel\"))";\
     print "          )";\
     print "        )";\
     print "      )";\
     print "  }";\
