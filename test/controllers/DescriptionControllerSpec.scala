...
class DescriptionControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val descriptionRoute = routes.DescriptionController.onPageLoad(NormalMode).url
  ...
  "Description Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      templateCaptor.getValue mustEqual "description.njk"
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val application = applicationBuilder(userAnswers = Some(emptyUserAnswers)).build()
      val request = FakeRequest(POST, descriptionRoute).withFormUrlEncodedBody(("value", ""))
